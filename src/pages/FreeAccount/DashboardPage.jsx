...
const holdings = [
  { name: "GOOGL", value: "13.00%", top: "20%", left: "76%" },
  { name: "NKE", value: "7.37%", top: "34%", left: "87%" },
  { name: "TLT", value: "7.12%", top: "51%", left: "85%" },
  { name: "META", value: "7.12%", top: "66%", left: "76%" },
  { name: "TSN", value: "6.30%", top: "80%", left: "54%" },
  { name: "AMZN", value: "5.81%", top: "82%", left: "30%" },
  { name: "PFE", value: "4.28%", top: "71%", left: "12%" },
  { name: "CRM", value: "3.53%", top: "29%", left: "10%" },
  { name: "INTC", value: "2.54%", top: "17%", left: "18%" },
  { name: "SPN", value: "0.70%", top: "16%", left: "66%" },
];
      ...
      <div className="max-w-[1480px] mx-auto px-6 py-6">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-[1.05fr_1.55fr_1.05fr] gap-4">
          ...
          <div className="bg-white border border-[#e7ebf3] rounded-2xl shadow-[0_4px_18px_rgba(31,41,55,0.04)] overflow-hidden">
            ...
            <div className="border-t border-[#edf1f7] px-5 py-3 flex items-start justify-between">
            ...
            <div className="border-t border-[#edf1f7] px-5 py-4">
              <div className="flex items-center gap-5">
                <div className="relative w-[150px] h-[150px] shrink-0">
                  ...
                  />
                  <div className="absolute inset-[25px] rounded-full bg-white flex items-center justify-center border border-[#edf1f7]">
                    <span className="text-[40px] leading-none text-[#44b06c]">$</span>
                  </div>
                </div>
              ...
              <div className="mt-4 rounded-xl border border-[#e7edf7] bg-[#eef4ff] px-4 py-2 text-center">
                <p className="text-[14px] font-bold uppercase tracking-wide text-[#35405c]">
                  Cantidad De Acciones
                </p>
                <p className="text-[36px] leading-none mt-1 font-bold text-[#3471e6]">
                  21
                </p>
              </div>
            </div>
          ...
          {/* CENTER COLUMN */}
          <div className="bg-white border border-[#e7ebf3] rounded-2xl shadow-[0_4px_18px_rgba(31,41,55,0.04)] px-5 py-3">
            <h3 className="text-center text-[20px] font-bold text-[#2f3a56] mb-1">
              ACCIONES
            </h3>
            ...
            <div className="relative h-[400px] flex items-center justify-center">
              ...
              <div
                className="relative w-[290px] h-[290px] rounded-full"
                style={{
                  background:
              ...
              >
                <div className="absolute inset-[78px] rounded-full bg-white border border-[#edf1f7]" />
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white border border-[#e7ebf3] rounded-2xl shadow-[0_4px_18px_rgba(31,41,55,0.04)] px-4 py-3 text-center h-[118px] flex flex-col justify-center">
                ...
                <p className="mt-2 text-[18px] font-bold text-[#24304a]">$ 2,973.40</p>
              </div>
              ...
              <div className="bg-white border border-[#e7ebf3] rounded-2xl shadow-[0_4px_18px_rgba(31,41,55,0.04)] px-4 py-3 text-center h-[118px] flex flex-col justify-center">
                ...
                <p className="mt-3 text-[18px] font-bold text-[#43b36d]">1.86%</p>
              </div>
            </div>

            <div className="bg-white border border-[#e7ebf3] rounded-2xl shadow-[0_4px_18px_rgba(31,41,55,0.04)] px-4 py-4">
              <h3 className="text-[18px] font-bold text-[#2f3a56] mb-3">
                Retorno Promedio Anual
              </h3>

              <div className="space-y-2">
                <div className="bg-[#eef4ff] rounded-xl px-4 py-2.5 flex items-center justify-between">
            ...
            <div className="bg-white border border-[#e7ebf3] rounded-2xl shadow-[0_4px_18px_rgba(31,41,55,0.04)] px-4 py-4">
              ...
              <div className="flex items-center gap-4">
                <div className="relative w-[135px] h-[135px] shrink-0">
                  ...
                  />
                  <div className="absolute inset-[28px] rounded-full bg-white border border-[#edf1f7]" />
                  <div className="absolute top-[14px] left-[72px] text-white text-[11px] font-bold">
                    54%
                  </div>
                  <div className="absolute bottom-[18px] left-[16px] text-white text-[11px] font-bold">
                    39%
                  </div>
                  <div className="absolute top-[14px] left-[34px] text-white text-[11px] font-bold">
                    7%
                  </div>
                </div>
