...
const holdings = [
  { name: "GOOGL", value: "13.00%", top: "18%", left: "80%" },
  { name: "NKE", value: "7.37%", top: "31%", left: "89%" },
  { name: "TLT", value: "7.12%", top: "47%", left: "88%" },
  { name: "META", value: "7.12%", top: "62%", left: "82%" },
  { name: "TSN", value: "6.30%", top: "84%", left: "58%" },
  { name: "AMZN", value: "5.81%", top: "86%", left: "28%" },
  { name: "PFE", value: "4.28%", top: "74%", left: "10%" },
  { name: "CRM", value: "3.53%", top: "26%", left: "10%" },
  { name: "INTC", value: "2.54%", top: "14%", left: "16%" },
  { name: "SPN", value: "0.70%", top: "14%", left: "70%" },
];
      ...
      <div className="max-w-[1480px] mx-auto px-6 py-6">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-[1.05fr_1.55fr_1.05fr] gap-4">
          ...
          <div className="bg-white border border-[#e7ebf3] rounded-2xl shadow-[0_4px_18px_rgba(31,41,55,0.04)] overflow-hidden">
            ...
            <div className="border-t border-[#edf1f7] px-5 py-4 flex items-start justify-between">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-md bg-[#66c38b] flex items-center justify-center text-white text-sm font-bold">
                  $
                </div>
                <div>
                  <p className="text-[15px] font-semibold text-[#3b455e]">
                    Efectivo
                  </p>
                </div>
              </div>
            ...
            <div className="border-t border-[#edf1f7] px-5 py-4 flex items-start justify-between">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-md bg-[#4678df] flex items-center justify-center text-white text-sm font-bold">
                  ▣
                </div>
                <div>
                  <p className="text-[15px] font-semibold text-[#3b455e]">
            ...
            <div className="border-t border-[#edf1f7] px-5 py-5">
              <div className="flex items-center gap-5">
                <div className="relative w-[150px] h-[150px] shrink-0">
                  ...
                  />
                  <div className="absolute inset-[24px] rounded-full bg-white flex items-center justify-center border border-[#edf1f7]">
              ...
              <div className="mt-5 rounded-xl border border-[#e7edf7] bg-[#eef4ff] px-4 py-3 text-center">
          ...
          <div className="bg-white border border-[#e7ebf3] rounded-2xl shadow-[0_4px_18px_rgba(31,41,55,0.04)] px-5 py-4">
            <h3 className="text-center text-[20px] font-bold text-[#2f3a56] mb-6">
              ACCIONES
            </h3>
            ...
            <div className="relative h-[500px] flex items-center justify-center">
              ...
              >
                <div className="absolute inset-[92px] rounded-full bg-white border border-[#edf1f7]" />
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white border border-[#e7ebf3] rounded-2xl shadow-[0_4px_18px_rgba(31,41,55,0.04)] px-4 py-4 text-center min-h-[108px] flex flex-col justify-center">
                <p className="text-[13px] md:text-[15px] leading-tight font-bold text-[#313b56]">
                  Dividendos Anuales
                  <br />
                  Estimados
                </p>
            ...
            <div className="bg-white border border-[#e7ebf3] rounded-2xl shadow-[0_4px_18px_rgba(31,41,55,0.04)] px-4 py-4">
              ...
              <div className="flex items-center gap-5">
                <div className="relative w-[150px] h-[150px] shrink-0">
                  ...
                  />
                  <div className="absolute inset-[34px] rounded-full bg-white border border-[#edf1f7]" />
                  <div className="absolute top-[18px] left-[80px] text-white text-[12px] font-bold">
                    54%
                  </div>
                  <div className="absolute bottom-[22px] left-[22px] text-white text-[12px] font-bold">
                    39%
                  </div>
                  <div className="absolute top-[18px] left-[44px] text-white text-[12px] font-bold">
                    7%
                  </div>
                </div>
